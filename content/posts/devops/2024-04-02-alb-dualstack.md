...
date: '2024-04-02'
category: devops
description: 졸업 작품팀에서 나는 백엔드 파트 및 인프라 구축을 담당하게 되었다. Terraform을 통해 VPC 환경을 구축하였고, Application Load Balancer 리소스를 사용하던 중 dualstack이라는 것을 알게 되어 게시글을 작성하게 되었다.
---
