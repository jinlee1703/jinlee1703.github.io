...
date: '2023-07-08'
category: web
description: 소프트웨어 마에스트로 14기 팀 프로젝트에서 나는 백엔드 파트를 담당하여 Spring Boot를 통한 WAS 서버 개발을 하게 되었다. WAS 서버를 개발하던 도중 내가 JWT의 동작 과정에 대해 100% 이해하지 못하고 있음을 깨닫게 되었고, 해당 게시글을 통해 복습을 하여 프로젝트에 완벽하게 녹여내고자 한다.
---
