...
date: '2023-07-27'
category: web
description: 소프트웨어 마에스트로 14기 팀 프로젝트에서 나는 백엔드 파트를 담당하여 Spring Boot를 통한 WAS 개발을 하게 되었다. 전담 멘토님께서 백엔드에서 지금 당장 TDD를 도입하기 보다는 BDD를 도입하는 것을 권장하셨고, BDD에 대해 이해해보고자 게시글을 작성하게 되었다.
---
