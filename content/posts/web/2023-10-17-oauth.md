...
date: '2023-10-17'
category: web
description: 소프트웨어 마에스트로 14기 팀 프로젝트에서 나는 백엔드 파트를 담당하여 Spring Boot를 통한 WAS 개발을 하게 되었다. OAuth를 통해 로그인 기능을 구현 중 이슈가 발생하게 되었고, 동작 과정을 100% 이해하여 이슈를 해결하고자 게시글을 작성하게 되었다.
---
