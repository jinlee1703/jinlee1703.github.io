...
date: '2023-07-26'
category: web
description: 소프트웨어 마에스트로 14기 팀 프로젝트에서 나는 백엔드 파트를 담당하여 Spring Boot를 통한 WAS 개발을 하게 되었다. WAS 서버를 개발하던 도중 여러 레퍼런스에서 API의 응답으로 ResponseEntity를 많이 사용하는 것을 보게 되었고, 이것이 무엇인가에 대해 궁금증이 생겨 게시글을 작성하게 되었다.
---
