...
date: '2023-08-12'
category: web
description: 영남대학교 멋쟁이사자처럼 대학 11기에서 BE 파트로 참여하면서, 멋쟁이사자처럼 대학 11기 해커톤에 참여하게 되었다. API를 설계하던 중 Controller의 동작 방식에 대해 궁금증이 생겼고, 이를 통해 팀원의 빠른 이해를 돕기 위해 게시글을 작성하게 되었다.
---
